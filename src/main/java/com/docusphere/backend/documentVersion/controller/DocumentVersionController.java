...
public class DocumentVersionController {
    ...
    public ResponseEntity<ApiResponse<DocumentVersionListResponse>> listVersions(
        ...
        return ResponseEntity.ok(ApiResponse.success("Version history fetched successfully", data));
    }
    ...
    public ResponseEntity<ApiResponse<SaveChangeSummaryResponse>> saveChangeSummary(
        ...
        SaveChangeSummaryResponse data = documentVersionService.saveChangeSummary(requesterId, documentId, changeSummary);
        return ResponseEntity.ok(ApiResponse.success("Change summary saved successfully", data));
    }
    ...
    public ResponseEntity<Resource> downloadVersion(
        ...
        Resource resource = documentVersionService.downloadVersionForSystem(documentId, versionId);
